A web-based shopping list app using JavaScript, HTML, and CSS. The two critical features  are the ability to 1) add items to the list, and 2) check them off.
...
http://jrojas.github.io/ShoppingList/index.html